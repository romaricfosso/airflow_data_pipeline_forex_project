...
def download_rates():
    ...
    with open('/opt/airflow/dags/files/forex_currencies.scv') as forex_currencies:
...
with DAG("forex_data_pipeline", start_date=datetime(2023, 12 ,17), 
    ...
    forex_processing = SparkSubmitOperator(
        ...
        application="/opt/airflow/dags/scriptsu/forex_processing.py",
        conn_id="spark_conn",
        verbose=False
    )
